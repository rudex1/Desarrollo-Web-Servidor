...
use testnamespace\Author;
use testnamespace\AuthorQuery;
...
class AuthorTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'testnamespace.Map.AuthorTableMap';
     ...
     */
    const OM_CLASS = '\\testnamespace\\Author';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'testnamespace.Author';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\testnamespace\\Author');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \testnamespace\Author) { // it's a model object

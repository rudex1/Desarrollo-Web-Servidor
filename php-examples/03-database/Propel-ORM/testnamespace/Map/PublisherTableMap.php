...
use testnamespace\Publisher;
use testnamespace\PublisherQuery;
...
class PublisherTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'testnamespace.Map.PublisherTableMap';
     ...
     */
    const OM_CLASS = '\\testnamespace\\Publisher';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'testnamespace.Publisher';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\testnamespace\\Publisher');
    ...
    {
        $this->addRelation('Book', '\\testnamespace\\Book', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':publisher_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \testnamespace\Publisher) { // it's a model object

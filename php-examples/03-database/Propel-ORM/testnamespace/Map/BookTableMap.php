...
class BookTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'testnamespace.Map.BookTableMap';
     ...
     */
    const OM_CLASS = '\\testnamespace\\Book';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'testnamespace.Book';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\testnamespace\\Book');
        $this->setPackage('testnamespace');
    ...
    {
        $this->addRelation('Publisher', '\\testnamespace\\Publisher', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':publisher_id',
    1 => ':id',
        ...
        $this->addRelation('Author', '\\testnamespace\\Author', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':author_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \testnamespace\Book) { // it's a model object

...
use testnamespace\Publisher as ChildPublisher;
use testnamespace\PublisherQuery as ChildPublisherQuery;
use testnamespace\Map\BookTableMap;
use testnamespace\Map\PublisherTableMap;
 ...
 *
 *
 * @package    propel.generator.testnamespace.Base
 */
abstract class Publisher implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\testnamespace\\Map\\PublisherTableMap';
    ...
    /**
     * Initializes internal state of testnamespace\Base\Publisher object.
     */
     ...
     * @return $this|\testnamespace\Publisher The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\testnamespace\\Publisher'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\testnamespace\Publisher
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\testnamespace\Publisher The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \testnamespace\Publisher (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \testnamespace\Publisher Clone of current object.
     * @throws PropelException
     */
    ...
    public function initBooks($overrideExisting = true)
    {
        ...
        $this->collBooks->setModel('\testnamespace\Book');
    }

...
use testnamespace\Author as ChildAuthor;
use testnamespace\AuthorQuery as ChildAuthorQuery;
use testnamespace\Book as ChildBook;
use testnamespace\BookQuery as ChildBookQuery;
use testnamespace\Map\AuthorTableMap;
...
abstract class Author implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\testnamespace\\Map\\AuthorTableMap';
    ...
    /**
     * Initializes internal state of testnamespace\Base\Author object.
     */
     ...
     * @return $this|\testnamespace\Author The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\testnamespace\\Author'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\testnamespace\Author
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\testnamespace\Author The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \testnamespace\Author (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \testnamespace\Author Clone of current object.
     * @throws PropelException
     */
